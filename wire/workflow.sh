...
for i in ${ls[@]}; do
  ...
  ../../SHgen/generator.py ../../SHgen/examples/rooms.l ../../SHgen/examples/layout.l ../../SHgen/examples/activities.l ../../SHgen/examples/basicpat.l #../../SHgen/examples/casas.l #casas.s #path1.ui
