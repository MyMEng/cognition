...
Up to date, extensive work on houses occupied with both \emph{single}~\citep{cook2009assessing,fatima2013unified} and \emph{multiple}~\citep{hsu2010strategies,singla2010recognizing,crandall2009coping} residents has been done, nevertheless, vast majority focused on state-of-the-art learning algorithm such as: transfer learning~\citep{cook2013transfer}, conditional random field~\citep{hsu2010strategies,van2010activity}, support vector machines with various kernels~\citep{fatima2013unified}, hidden Markov model~\citep{rashidi2011discovering}, na\"{\i}ve Bayes~\citep{cook2013activity}, artificial neural networks~\citep{fatima2013unified,fatima2013analysis}. All of these models are fuelled by features extracted from raw signals different combiantion and structure of features  in different time windows or units.\\

All methods  Such strategies are well dicovered in literature and described but authors forget about non classical learning algorithms
forgetting about simple non straight forward solution hence there is still huge space for discovery.


Characteristic feature of majority fo these appers use mainly motion sensors - main power, with little to none attention to item sensors\\

    \subsubsection{Datasets}
Training and testing any activity recognition model needs a dataset of recorded human activities. Such data can be only obtained by designing and building a test-bed house fitted with variety of sensors and ``playing'' in it scripted activities. As majority of researchers cannot invest time or money to construct a smart house they use publicly available datasets generated by on of research facility. The most popular choice~\citep{fatima2013unified,fatima2013analysis,nazerfard2010conditional,cook2009assessing} are published by \citet{cook2009assessing} Washington State University \emph{Center for Advanced Studies in Adaptive Systems (CASAS) datasets}. They popularity is wariate of activities, single and multiple occupiers, well formated good description and large amount; they have problems with label structure.\\
