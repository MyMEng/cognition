...
The activity recognition model built with presented above components\\

The output model is purified from singleton rules.\\
than 10 fold cross-validation is performed on data generated with the same script but introduced some variations to path and timing.
