...
Despite huge popularity in healthcare, spatio-temporal data feeds can also be found in variety of monitoring applications. One of them described by \citet{filipponi2010smart} is smart-city management. Automatic analysis of traffic information, accident reports.


Evacuation, crowd management, terrorist attack prevention
airport control, and security checks
Good analysis can result in timely police intervention, root planning for emergency services.

      \subsubsection{Complex systems monitoring and control}
Many of todays comlex systems like buildings, power plants, 
power distribution and ballancing \cite{amin2005toward}
to make management and risk detection quick and flawless

data centre management \cite{moore2005data}

      \subsubsection{Wildlife monitoring}
animal behavior for researchers \citet{Szewczyk:2004:HMS:990680.990704}
not disturbing their natural habitats and life
