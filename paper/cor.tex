...
data generator that produces real like data -> higly customisalbels, allowing personalisation of room layout and motion sensor, publiclally available, free, \\

rules for activity (that are considered difficult to recognise) recognition of single person in house\\
techniques and advantages for\\
