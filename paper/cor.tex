...
for the moment impossible to predict a person.\\
The idea is to check for sensor changes in each room in sliding time window -- if signal still the resident is out.\\
