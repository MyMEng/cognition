...
To strart with data ere eyeballed to confirm what is scripted---based on examinaiton patterns are piocked up\\
...
WHY I chose this that and that!!!!!!!!!!!!

  \section{Scripted data}
about scripted data: in detail step by step no detours <- good starting point

    \subsection{Sequential multi-class model for single resident\label{ch:smcm}}
What are model assumptions\\
how target rule looks like\\
what I want to ahieve and why\\

    \subsection{Basic activities}
1. start with basics to discover how ILP realy works like and what the algorithm does with the data. -- CASAS \#1\#2 inspierd scripted data
1.1 encode something in the data
1.2 design features to pick it up
1.3 learn it with ILP
