...
The dataset is generated accordoing to above description\\
So far designed features are extended or to support multiple returns.\\
Then wrappers are created with \texttt{findall} \texttt{Prolog} predicate to return lists instead of constants.\\
