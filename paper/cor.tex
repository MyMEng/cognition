...
In this model the initial person identification is achieved by person-bedroom assignment---it is represented as fact in the background knowledge. As item sensors are not used the activity recognition is only based on the motion sensors.\\
...
Binary classification of prediction pair (res\_1, room\_1), (res\_2, room\_2) given in \emph{Figure~\ref{tab:mulResStats}}.\\
...
\multirow{2}{*}{\emph{Overall}}
 & \emph{Rule based} & 94.44\% & 0.96 & 0.98 & 0.97 \\
 & \emph{Majority class} & 81.48\% & 0.81 & 1 & 0.9\\
\cline{2-6}\\
\cline{2-6}
 \multirow{2}{*}{\emph{Per resident}}
 & \emph{Rule based} & 98.15\% & 1 & 0.98 & 0.99\\
 & \emph{Majority class} & 100\% & 1 & 1 & 1\\
\cline{2-6}\\
\cline{2-6}
 \multirow{2}{*}{\emph{Per activity}}
 & \emph{Rule based} & 94.44\% & 0.96 & 0.98 & 0.97\\
 & \emph{Majority class} & 81.48\% & 0.81 & 1 & 0.90\\
  \end{tabular}
